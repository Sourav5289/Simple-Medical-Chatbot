...
"causes": ["Immune disorder", "Genetics"], "remedies": ["Topical creams", "Medication"]},
...
"description": "Diphtheria affects the throat and
...
"causes": ["Bacterial infection through wounds"], "remedies": ["Vaccination", "Medical treatment"]},
"rabies": {

"description": "Rabies is a fatal viral disease
...
"description": "Chikungunya is a viral disease

causing joint pain and fever.
...
"causes": ["Stress", "Diabetes", "Heart disease"], "remedies": ["Lifestyle changes", "Medication"]},
"endometriosis": {
...
"remedies": ["Pain medication", "Hormone
...
"polycystic_ovary_syndrome": { "description": "PCOS is a hormonal disorder affecting women.",

},

"causes": ["Hormonal imbalance", "Genetics"], "remedies": ["Lifestyle changes", "Medication"]},
"hyperthyroidism": {
...
"hypothyroidism": { "description": "Hypothyroidism is underactive thyroid hormone production."
...
"causes": ["Alcohol abuse", "Gallstones"], "remedies": ["Hospital care", "Fluids", "Pain
...
"causes": ["Obesity", "Alcohol consumption"], "remedies": ["Weight loss", "Healthy diet", "Avoid

alcohol"]},
"chronic_kidney_disease": { "description": "CKD is gradual loss of kidney

function.",

"causes": ["Diabetes", "High blood pressure"], "remedies": ["Diet control", "Medication",
...
"causes": ["Low fiber intake", "Dehydration"], "remedies": ["Fiber-rich diet", "Water intake",
...
"causes": ["High uric acid levels", "Diet"], 'remedies": ["Medication", "Low-purine diet",
...
"description": "Otitis media is a middle ear
...
"remedies": ["Voice rest", "Steam inhalation",
...
"remedies": ["Warm fluids", "Antibiotics if

bacterial", "Rest"]},
"vertigo": {

"description": "Vertigo is a sensation of spinning or

dizziness."

"causes": ["Inner ear problems", "Head injury"], "remedies": ["Balance exercises", "Medication",

"Rest"]},
"insomnia": {

"description": "Insomnia is difficulty falling or
...
"remedies": ["Counseling", "Medication", "Lifestyle
...
"causes": ["Genetics", "Autoimmune disorder",
...
"causes": ["Viral infections", "Smoking", "Polluted
...
"causes": ["Allergic reaction", "Genetics",
...
"description": "Appendicitis is inflammation of

the appendix causing severe abdominal pain.", "causes": ["Blockage of the appendix", "Infection"],
...
"remedies": ["Antibiotics", "Drink plenty of

water", "Maintain hygiene"]},
"pneumonia": {

"description": "Pneumonia is an infection that inflames the lungs' air sacs.",

"causes": ["Bacteria", "Viruses", "Fungi"],"remedies": ["Antibiotics", "Rest", "Fluids",
...
"description": "Anemia is a condition where the body lacks enough healthy red blood cells.", "causes": ["Iron deficiency", "Vitamin B12
...
"causes": ["Iron deficiency", "Vitamin B12

deficiency", "Chronic diseases"],

"remedies": ["Iron supplements",

greens", "Vitamin B12 injections"]},
tuberculosis":
...
"remedies": ["Long-term antibiotics", "Good

nutrition", "Regular doctor check-ups"]},
measles": {

"description": "Measles is a highly contagious viral infection that causes fever, rash, and cough.",
cough.",

"causes": ["Measles virus", "Exposure to infected

droplets"],"remedies": ["Vitamin A supplements",

"Hydration", "Fever reducers"]},

chickenpox": {

"description": "Chickenpox is a viral infection

causing an itchy rash with small, fluid-filled blisters.",
...
"remedies": ["Use antihistamines", "Apply soothing

creams", "Avoid allergens", "Keep skin clean"]},
diabetes": {

"description": "Diabetes is a chronic condition where the body cannot regulate blood sugar
...
hypertension":
"description": "Hypertension is a condition where blood pressure is persistently higher than normal.",causes": ["Stress", "Obesity", "High salt intake", "Genetics"],
"remedies": ["Reduce salt intake", "Exercise regularly", "Take prescribed medication", "Manage stress"]},

"fever": {
 "description": "Fever is a temporary increase in body 
temperature, often due to illness.",
 "causes": ["Infection (viral or bacterial)", "Heat 
exhaustion", "Certain medications"],
 "remedies": ["Rest and drink fluids", "Take fever reducers 
like acetaminophen", "Cool compress", "Monitor temperature"]
 },
typhoid":
"description": "Typhoid is a bacterial infection that spreads through contaminated food and water.", "causes": ["Salmonella typhi bacteria", "Contaminated food", "Contaminated water"],
"remedies": ["Antibiotics", "Drink clean water" "Proper hygiene", "Rest and fluids"]},
malaria": {
"description": "Malaria is a mosquito-borne infectious disease caused by Plasmodium parasites.", "causes": ["Bite of infected Anopheles mosquito", "Travel to malaria-prone areas"],
"remedies": ["Antimalarial medications", "Use mosquito nets", "Stay hydrated", "Seek medical
},
asthma": {
"description": "Asthma is a chronic condition where airways become inflamed and narrow, causing breathing difficulty.",causes": ["Allergens", "Air pollution", "Exercise", "Respiratory infections"],"remedies": ["Use inhalers", "Avoid triggers", "Breathing exercises", "Take prescribed medications"]},
diarrhea": {
...
"remedies": ["Drink ORS", "Avoid spicy foods",
"Eat bananas, rice, toast", "Consult a doctor if
severe"]
},
"cough": {
 "description": "A cough is a reflex action to clear your 
airways.",
 "causes": ["Common cold", "Flu", "Allergies", "Asthma", 
"COVID-19"],
 "remedies": ["Stay hydrated", "Use cough drops", "Try 
honey (for adults)", "Use a humidifier"]
 }
}
...
Check for greetings
 ...
 "Greetings! I'm here to provide general health 
information."
 ])
...
# Check for farewells
 ...
 "Goodbye! Remember to consult a doctor for serious 
symptoms.",
...
# Check for symptoms in the database
 ...
 if symptom in user_input:
    ...
    response += f"Suggested remedies: {', 
'.join(info['remedies'])}\n"
    response += "Note: If symptoms persist or worsen, please 
consult a doctor."
    return response


Default response if no matches found
return "I'm sorry, I can only provide information about 
common symptoms like headache, fever, and cough. For other 
concerns, please consult a healthcare professional."


def main():
    print("MediBot: Hello! I'm a simple medical chatbot. I can 
